...
namespace ExtScripts
{
    public class Svd
    {
        private const float Gamma = 5.828427124f;
        private const float CStar = 0.923879532f;
        private const float SStar = 0.3826834323f;
        private const float Epsilon = 1e-6f;

        private static float AccurateSqrt(float x)
        {
        ...
        private static void CondNegSwap(bool c, ref float x, ref float y)
        {
        ...
        private static void MultAb(float a11, float a12, float a13,
        ...
        private static void MultAtB(float a11, float a12, float a13,
            float a21, float a22, float a23,
            float a31, float a32, float a33,
            //
            float b11, float b12, float b13,
        ...
        private static void QuaternionToMatrix3(IReadOnlyList<float> qV,
            ref float m11, ref float m12, ref float m13,
            ref float m21, ref float m22, ref float m23,
            ref float m31, ref float m32, ref float m33
        )
        ...
        private static void ApproximateGivensQuaternion(float a11, float a12, float a22, ref float ch, ref float sh)
        {
            /*
            ...
            ch = 2 * (a11 - a22);
            sh = a12;
            var b = Gamma * sh * sh < ch * ch;
            var w = 1 / Mathf.Sqrt(ch * ch + sh * sh);
            ch = b ? w * ch : CStar;
            sh = b ? w * sh : SStar;
        }

        private static void JacobiConjugation(int x, int y, int z,
            ref float s11,
        ...
        private static float Dist2(float x, float y, float z)
        {
            return x * x + y * y + z * z;
        }

        // finds transformation that diagonalizes a symmetric matrix
        private static void JacobiEigenAnalysis( // symmetric matrix
            ref float s11,
            ref float s21, ref float s22,
            ref float s31, ref float s32, ref float s33,
        ...
        private static void SortSingularValues( // matrix that we want to decompose
            ...
            ref float v31, ref float v32, ref float v33)
        {
            ...
            var rho2 = Dist2(b12, b22, b23);
            var rho3 = Dist2(b13, b23, b33);
            bool c;
            c = rho1 < rho2;
            CondNegSwap(c, ref b11, ref b12);
            CondNegSwap(c, ref v11, ref v12);
            CondNegSwap(c, ref b21, ref b22);
            CondNegSwap(c, ref v21, ref v22);
            CondNegSwap(c, ref b31, ref b32);
            CondNegSwap(c, ref v31, ref v32);
            CondSwap(c, ref rho1, ref rho2);
            c = rho1 < rho3;
            CondNegSwap(c, ref b11, ref b13);
            CondNegSwap(c, ref v11, ref v13);
            CondNegSwap(c, ref b21, ref b23);
            CondNegSwap(c, ref v21, ref v23);
            CondNegSwap(c, ref b31, ref b33);
            CondNegSwap(c, ref v31, ref v33);
            CondSwap(c, ref rho1, ref rho3);
            c = rho2 < rho3;
            CondNegSwap(c, ref b12, ref b13);
            CondNegSwap(c, ref v12, ref v13);
            CondNegSwap(c, ref b22, ref b23);
            CondNegSwap(c, ref v22, ref v23);
            CondNegSwap(c, ref b32, ref b33);
            CondNegSwap(c, ref v32, ref v33);
        }

        private static void QrGivensQuaternion(float a1, float a2, ref float ch, ref float sh)
        {
            // a1 = pivot point on diagonal
            // a2 = lower triangular entry we want to annihilate
            var epsilon = Epsilon;
            var rho = AccurateSqrt(a1 * a1 + a2 * a2);
        ...
        private static void QrDecomposition( // matrix that we want to decompose
            float b11, float b12, float b13,
            float b21, float b22, float b23,
            float b31, float b32, float b33,
            // output Q
        ...
        private static void SvdFunc( // input A
            ...
            ref float v31, ref float v32, ref float v33)
        {
            ...
            var qV = new float[4];
            JacobiEigenAnalysis(ref ATA11, ref ATA21, ref ATA22, ref ATA31, ref ATA32, ref ATA33, qV);
            QuaternionToMatrix3(qV, ref v11, ref v12, ref v13, ref v21, ref v22, ref v23, ref v31, ref v32, ref v33);
        ...
        public void SvdFinal(Matrix4x4 A, ref Matrix4x4 U, ref Matrix4x4 S, ref Matrix4x4 V)
        {
