...
public class SVD
{
	...
	void quatToMat3(ref Vector4 qV,
	ref float m11, ref float m12, ref float m13,
	ref float m21, ref float m22, ref float m23,
	ref float m31, ref float m32, ref float m33
	)
	                                ...
	                                ref Vector4 qV)
	{
	    ...
	    for (int i=0;i<10;i++)
	    {
	        ...
	        jacobiConjugation(0,1,2,ref s11,ref s21,ref s22,ref s31,ref s32,ref s33, ref qV); // p,q = 0,1
	        jacobiConjugation(1,2,0,ref s11,ref s21,ref s22,ref s31,ref s32,ref s33, ref qV); // p,q = 1,2
	        jacobiConjugation(2,0,1,ref s11,ref s21,ref s22,ref s31,ref s32,ref s33, ref qV); // p,q = 0,2
	    }
	}
	        ...
	        ref float v31, ref float v32, ref float v33)
	{
		...
		Vector4 qV = new Vector4();
	    jacobiEigenanlysis(ref ATA11,ref ATA21,ref ATA22,ref ATA31,ref ATA32,ref ATA33,ref qV);
	    quatToMat3(ref qV,ref v11,ref v12,ref v13,ref v21,ref v22,ref v23,ref v31,ref v32,ref v33);
